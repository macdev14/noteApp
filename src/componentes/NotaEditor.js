...
export default function NotaEditor({ mostraNotas, notaSelecionada, setNotaSelecionada }) {
  ...
  async function salvaNota() {
    ...
    console.log(await adicionaNota(umaNota));
    limpaModal();
    await mostraNotas();
  ...
  async function modificaNota() {
    ...
    console.log(await atualizaNota(umaNota));
    limpaModal();
    await mostraNotas();
        ...
        <View style={estilos.centralizaModal}>
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={estilos.modal}>
              <Text style={estilos.modalTitulo}>{notaParaAtualizar ? 'Atualizar Nota' : 'Criar nota'}</Text>
